...
public class UnTarUtils {
    ...
    public static void decompressFile(File srcFile, File destFile, List<ChangeSourceVo> fileList, Long userID) throws Exception {
        ...
        try {
            zis = new TarArchiveInputStream(new FileInputStream(srcFile));
            //解压zip
     ...
     * @throws Exception
     */
    private static void decompressFile(File destFile, TarArchiveInputStream zis) throws Exception {
        //创建输出流
     ...
     * @throws Exception
     */
    private static void decompressZis(File destFile, TarArchiveInputStream zis, List<ChangeSourceVo> fileList, Long userID)   throws Exception {
        ArchiveEntry entry;
    ...
    /*public static void main(String[] args) {
        String unzipPath = "E:\\zip测试打包\\999\\解压tar\\";
        String zipPath = "E:\\zip测试打包\\999\\5d1a615c9b9a4635b3c6286fa2b64b791680600305329_1.tar";
