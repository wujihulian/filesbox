...
public enum FileType {
    ...
    private static final String[] SSIM_TEXT_TYPES = {"txt","html","htm","asp","jsp","xml","json","properties","md","gitignore","log","java","py","c","cpp","sql","sh","bat","m","bas","prg","cmd","smm"};
    private static final String[] CODES = {"java", "c", "php", "go", "python", "py", "js", "html", "ftl", "css", "lua", "sh", "rb", "yaml", "yml", "json", "h", "cpp", "cs", "aspx", "jsp","smm"};
    private static final String[] MEDIA_TYPES = {"mp3","wav","mp4","flv"};
    public static final String[] MEDIA_TYPES_CONVERT = {"avi","mov","wmv","mkv","3gp","rm"};
