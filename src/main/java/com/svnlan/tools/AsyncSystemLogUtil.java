...
public class AsyncSystemLogUtil {
    ...
    public void setSysLog(LoginUser loginUser, String opType, List<Map<String, Object>> paramList, String serverName, String ua, String resolution, String ip) {
        ...
        this.addSysLog(logLogin, paramList);
    ...
    public void addSysLog(LogLogin logLogin, List<Map<String, Object>> paramList) {
        ...
        String visitDate = DateDUtil.getYearMonthDayHMS(new Date(), "yyyy-MM-dd");
        ...
        if (!CollectionUtils.isEmpty(paramList)) {
            ...
            for (Map map : paramList) {
                if (map.containsKey("sourceParentLevel") && !ObjectUtils.isEmpty(map.get("sourceParentLevel"))) {
                    ...
                    // 个人空间
                    HomeExplorerVO space = this.mySpaceDefault(logLogin.getUserID());
                    // space.getSourceID()
