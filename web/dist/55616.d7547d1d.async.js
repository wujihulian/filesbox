(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[55616],{55616:function(a,d,o){a=o.nmd(a),ace.define("ace/theme/cloud9_day.css",["require","exports","module"],function(n,c,e){e.exports=`.ace-cloud9-day .ace_gutter {
    background: #ECECEC;
    color: #333;
}
...
`}),ace.define("ace/theme/cloud9_day",["require","exports","module","ace/theme/cloud9_day.css","ace/lib/dom"],function(n,c,e){"use strict";c.isDark=!1,c.cssClass="ace-cloud9-day",c.cssText=n("./cloud9_day.css");var r=n("../lib/dom");r.importCssString(c.cssText,c.cssClass)}),function(){ace.require(["ace/theme/cloud9_day"],function(n){a&&(a.exports=n)})}()}}]);
