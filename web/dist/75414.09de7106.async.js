(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[75414],{75414:function(_,t,e){_=e.nmd(_),ace.define("ace/snippets/gobstones.snippets",["require","exports","module"],function(n,T,p){p.exports=`# scope: gobstones
...
snippet docs (funci\xF3n con par\xE1metros)
	/*
		...
		@TIPO: \${6:...}
	*/
`}),ace.define("ace/snippets/gobstones",["require","exports","module","ace/snippets/gobstones.snippets"],function(n,T,p){"use strict";T.snippetText=n("./gobstones.snippets"),T.scope="gobstones"}),function(){ace.require(["ace/snippets/gobstones"],function(n){_&&(_.exports=n)})}()}}]);
