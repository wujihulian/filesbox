(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[74936],{74936:function(r,l,a){r=a.nmd(r),ace.define("ace/theme/sqlserver.css",["require","exports","module"],function(n,e,c){c.exports=`.ace-sqlserver .ace_gutter {
    background: #ebebeb;
    color: #333;
    overflow: hidden;
}
...
`}),ace.define("ace/theme/sqlserver",["require","exports","module","ace/theme/sqlserver.css","ace/lib/dom"],function(n,e,c){e.isDark=!1,e.cssClass="ace-sqlserver",e.cssText=n("./sqlserver.css");var s=n("../lib/dom");s.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/sqlserver"],function(n){r&&(r.exports=n)})}()}}]);
