(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[21831],{21831:function(e,r,a){e=a.nmd(e),ace.define("ace/snippets/vala",["require","exports","module"],function(n,t,c){"use strict";t.snippets=[{content:`case \${1:condition}:
	$0
	break;
...
`,name:"namespace (ns)",scope:"vala",tabTrigger:"ns"},{content:"stdout.printf($0);",name:"printf",scope:"vala",tabTrigger:"printf"},{content:`\${1:public} \${2:Type} \${3:Name} {
	...
	$0
}`,name:"while",scope:"vala",tabTrigger:"while"}],t.scope=""}),function(){ace.require(["ace/snippets/vala"],function(n){e&&(e.exports=n)})}()}}]);
