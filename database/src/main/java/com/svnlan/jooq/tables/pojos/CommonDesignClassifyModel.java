...
public class CommonDesignClassifyModel implements Serializable {

    private static final long serialVersionUID = -2072560713;
    ...
    public CommonDesignClassifyModel() {}

    public CommonDesignClassifyModel(CommonDesignClassifyModel value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CommonDesignClassifyModel (");
