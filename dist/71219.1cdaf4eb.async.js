(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[71219],{71219:function(n,r,l){n=l.nmd(n),ace.define("ace/theme/cloud9_night_low_color.css",["require","exports","module"],function(c,o,e){e.exports=`.ace-cloud9-night-low-color .ace_gutter {
    background: #303130;
    color: #eee
}
...
`}),ace.define("ace/theme/cloud9_night_low_color",["require","exports","module","ace/theme/cloud9_night_low_color.css","ace/lib/dom"],function(c,o,e){o.isDark=!0,o.cssClass="ace-cloud9-night-low-color",o.cssText=c("./cloud9_night_low_color.css");var a=c("../lib/dom");a.importCssString(o.cssText,o.cssClass)}),function(){ace.require(["ace/theme/cloud9_night_low_color"],function(c){n&&(n.exports=c)})}()}}]);
