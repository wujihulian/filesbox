(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[1219],{48202:function(t,s,p){t=p.nmd(t),ace.define("ace/snippets/python.snippets",["require","exports","module"],function(n,e,i){i.exports=`snippet #!
	#!/usr/bin/env python
snippet imp
	import \${1:module}
snippet from
