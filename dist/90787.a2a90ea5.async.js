(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[90787],{90787:function(n,m,t){n=t.nmd(n),ace.define("ace/theme/terminal.css",["require","exports","module"],function(a,e,c){c.exports=`.ace-terminal-theme .ace_gutter {
  background: #1a0005;
  color: steelblue
}
...
`}),ace.define("ace/theme/terminal",["require","exports","module","ace/theme/terminal.css","ace/lib/dom"],function(a,e,c){e.isDark=!0,e.cssClass="ace-terminal-theme",e.cssText=a("./terminal.css");var r=a("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/terminal"],function(a){n&&(n.exports=a)})}()}}]);
