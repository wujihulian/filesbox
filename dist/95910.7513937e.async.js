(self.webpackChunkant_design_pro=self.webpackChunkant_design_pro||[]).push([[95910],{95910:function(r,i,c){r=c.nmd(r),ace.define("ace/theme/merbivore.css",["require","exports","module"],function(n,e,a){a.exports=`.ace-merbivore .ace_gutter {
  background: #202020;
  color: #E6E1DC
}
...
`}),ace.define("ace/theme/merbivore",["require","exports","module","ace/theme/merbivore.css","ace/lib/dom"],function(n,e,a){e.isDark=!0,e.cssClass="ace-merbivore",e.cssText=n("./merbivore.css");var o=n("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/merbivore"],function(n){r&&(r.exports=n)})}()}}]);
