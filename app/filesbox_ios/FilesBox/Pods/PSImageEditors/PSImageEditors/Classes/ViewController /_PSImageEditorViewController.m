    ...
    switch (event) {
        case PSTopToolBarEventCancel: {
			...
			if (self.produceChanges) {
				UIAlertController *alertController = [UIAlertController alertControllerWithTitle:KLanguage(@"是否放弃当前图片操作?")
																						 message:nil
																				  preferredStyle:UIAlertControllerStyleAlert];
				

				 UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:KLanguage(@"继续") style:UIAlertActionStyleDefault handler:NULL];
				 [alertController addAction:confirmAction];

				UIAlertAction *destructiveAction = [UIAlertAction actionWithTitle:KLanguage(@"放弃") style:UIAlertActionStyleDestructive
