...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SJXSignTextView/SJXSignTextView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TKCarouselView/TKCarouselView.framework"
