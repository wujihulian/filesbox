...
{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:KLanguage(@"提示") message:message ? message : @"" preferredStyle:UIAlertControllerStyleAlert];
    ...
    [alertController addAction:([UIAlertAction actionWithTitle:KLanguage(@"确认" ) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
