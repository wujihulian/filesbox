...
- (void)viewDidLoad {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [weekSelf.webView mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)webView:(WKWebView *)webView didReceiveAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge completionHandler:(void (^)(NSURLSessionAuthChallengeDisposition disposition, NSURLCredential * _Nullable credential))completionHandler{
    ...
    if ([authenticationMethod isEqualToString:NSURLAuthenticationMethodDefault]
        ...
        [alertController addAction:[UIAlertAction actionWithTitle:KLanguage(@"确定") style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        [alertController addAction:[UIAlertAction actionWithTitle:KLanguage(@"取消" ) style:UIAlertActionStyleCancel handler:^(UIAlertAction *action) {
...
- (UIProgressView *)wkProgressView {
    if (!_wkProgressView) {
        ...
        CGRect barFrame = CGRectMake(0, VUL_IS_NOTCH ? 20 : 0, WKSCREEN_WIDTH, progressBarHeight);
