...
#define kSemiModalViewController           @"PaPQC93kjgzUanzkpl"
#define kSemiModalDismissBlock             @"l27h7RU2dzVfPoQkpl"
#define kSemiModalPresentingViewController @"QKWuTQjUkWaO1Xrkpl"

#define kSemiModalOverlayTag               10005
#define kSemiModalScreenshotTag            10006
#define kSemiModalModalViewTag             10007
#define kSemiModalDismissButtonTag         10008
...
-(void)kn_registerDefaultsAndOptions:(NSDictionary*)options {
	[self ym_registerOptions:options defaults:@{
     ...
     KNSemiModalOptionKeys.parentScale : @(0.97),
...
//        [target drawViewHierarchyInRect:target.bounds afterScreenUpdates:YES]; jq
