...
{
    UIView *t = [self viewWithTag:TOAST_TAG];
    if(t){
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (CSToastDisplayShadow) {
        wrapperView.layer.shadowColor = [UIColor colorWithRed:0.62 green:0.83 blue:0.41 alpha:1].CGColor;
        wrapperView.layer.shadowOpacity = CSToastShadowOpacity;
        wrapperView.layer.shadowRadius = CSToastShadowRadius;
        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    }

//    wrapperView.backgroundColor = [UIColor colorWithRed:0.36 green:0.7 blue:0.93 alpha:1];
//    wrapperView.backgroundColor = HEXCOLOR(0x73B6F5);
    wrapperView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.6];
