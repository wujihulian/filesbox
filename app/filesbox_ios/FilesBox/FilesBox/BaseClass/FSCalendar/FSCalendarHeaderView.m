...
- (void)layoutSubviews
{
    ...
    self.collectionView.frame = CGRectMake(0, self.fs_height*0, self.fs_width, self.fs_height*0.9);
    self.lineView.frame = CGRectMake(0, self.fs_height*0.95, self.fs_width, 0.7);
}
