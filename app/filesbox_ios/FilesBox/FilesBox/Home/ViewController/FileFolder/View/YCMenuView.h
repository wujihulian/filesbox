...
@property (nonatomic,retain)  NSArray                       *separatorIndexArray;
@property (nonatomic,assign)  BOOL                          isNoPre;//没有权限
...
+ (instancetype)actionWithTitle:(NSString *)title image:(UIImage *)image rightImage:(UIImage *)image handler:(void (^)(YCMenuAction *action))handler;
