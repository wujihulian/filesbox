...
public class UploadDTO {
    ...
    public String getUpdateTmpPath() {
        return updateTmpPath;
    }

    public void setUpdateTmpPath(String updateTmpPath) {
        this.updateTmpPath = updateTmpPath;
    }
