...
public class SystemConstant {
    ...
    public static final Long JWT_TTL = 3600 * 24 * 90 * 2 * 1000L; // token有效时间，失效时间2年, 相当于永久有效

    public static final Long JWT_REDIS_TTL = 3600 * 24 * 30 * 1000L; //token实际有效时间，30天，redis tll

    public static final Long JWT_REDIS_LONG_TTL = 3600 * 24 * 60 * 1000L; //token实际有效时间，长期保存的，365天
