...
//        int VERIFICATION_IMAGE_HEIGHT = verificationImage.getHeight();
    ...
    public static ImageVerificationVo pictureTemplateCutout(BufferedImage originImage, InputStream inputStream, String originImageFileType, BufferedImage templateImage, String templateImageFileType, int x, int y) {
        ...
        try {
            ...
            LogUtil.error(e, "pictureTemplateCutout IOException");
...
//            Iterator<ImageReader> imageReaderIterator = ImageIO.getImageReadersByFormatName(originImageType);
            ...
            LogUtil.error(e, "getInterestArea IOException");
            throw new SvnlanRuntimeException(CodeMessageEnum.codeError.getCode());
        } finally {
            try {
     ...
     * @return 图片容器
     */
    public static ImageVerificationVo cutoutImageEdge(ImageVerificationVo imageVerificationVo, BufferedImage borderImage, String borderImageFileType) {
        ...
        try {
            ...
            LogUtil.error(e, "cutoutImageEdge IOException");
            throw new SvnlanRuntimeException(CodeMessageEnum.codeError.getCode());
        } finally {
            try {
