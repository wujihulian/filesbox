...
public class SystemLogTool {
    ...
    public void setSysLog(LoginUser loginUser, String opType, List<Map<String, Object>> paramList, HttpServletRequest request) {
        setSysLog( loginUser, opType, paramList, request, null);
    }
    public void setSysLog(LoginUser loginUser, String opType, List<Map<String, Object>> paramList, HttpServletRequest request, String sessionId) {
        setSysLog( loginUser, opType, paramList, request, sessionId, "");
    }
    public void setSysLog(LoginUser loginUser, String opType, List<Map<String, Object>> paramList, HttpServletRequest request, String sessionId, String country) {
        ...
        asyncSystemLogUtil.setSysLog(loginUser,  opType, paramList, serverName, ua, resolution, ip, tenantId,sessionId, country);
    }
