...
public class SystemLogController {
    ...
    public void exportLogExcel(@RequestBody SystemLogDto systemLogDto, HttpServletResponse response) {
    ...
    public void downloadLogOperate(@RequestBody SystemLogDto systemLogDto, HttpServletResponse response) {
