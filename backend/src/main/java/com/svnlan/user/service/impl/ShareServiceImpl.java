...
public class ShareServiceImpl implements ShareService {
    ...
    private void changeShareListParam(ShareDTO dto){

        dto.setTenantId(tenantUtil.getTenantIdByServerName());
        ...
        switch (dto.getSortField()){
            case "createTime":
                ...
                break;
            case "timeTo":
                dto.setSortField("time_to");
                break;
            case "numDownload":
                dto.setSortField("num_download");
                break;
            case "numView":
                dto.setSortField("num_view");
                break;
        }
    }
