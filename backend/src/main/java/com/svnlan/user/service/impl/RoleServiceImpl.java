...
import com.svnlan.user.vo.RoleVo;
...
public class RoleServiceImpl implements RoleService {
    ...
    public List getRoleList(LoginUser loginUser, RoleDTO paramDto) {
        ...
        List<Role> roleList = roleDaoImpl.getRoleList(paramDto);
        ...
        for (Role role : roleList){
            vo = new RoleVo();
            vo.setAdministrator(role.getAdministrator());
            vo.setAuth(role.getAuth());
            vo.setDescription(role.getDescription());
            vo.setEnable(role.getEnable());
            vo.setIgnoreExt(role.getIgnoreExt());
            vo.setIgnoreFileSize(role.getIgnoreFileSize());
            ...
            vo.setModifyTime(Timestamp.valueOf(role.getModifyTime()).getTime() / 1000);
            list.add(vo);
        }
        return list;
    }
    ...
    public void editRole(String prefix, LoginUser loginUser, RoleDTO paramDto) {
        ...
        role.setTenantId(tenantUtil.getTenantIdByServerName());
        /** 添加权限 */
