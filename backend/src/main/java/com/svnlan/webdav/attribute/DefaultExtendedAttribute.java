...
class DefaultExtendedAttribute implements ExtendedAttribute {
    ...
    public static void main(String[] args) throws IOException {
        DefaultExtendedAttribute defaultExtendedAttribute = new DefaultExtendedAttribute();
        defaultExtendedAttribute.setExtendedAttribute("/Users/zhanghanyi/WorkSpace/wuji/project/real_disk/file_data/ali_data/private/cloud/WEBDAV-INF/index.html",
                "SerialNumber", "2");
